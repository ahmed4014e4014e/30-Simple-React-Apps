...
export default function Card({ player, defenseValue, attackValue, unitTypeName, unitTypeImg, moralValue, unitValue }) {
  let iconStyle = {
    marginRight: 10,
    width: 20,
  ...
  mirrorImg(player);
  return (
    <div className={`card text-center m-1 shadow-lg ${player === "player_1" ? "card-info" : "card-danger"}`} style={{ width: 180 }}>
      ...
      <section className='card-body'>
        <h4 className="mb-1">
          ...
          <img src={unitTypeImg} alt="unitTypeImg" style={{ background: "#fff", transform: `${mirror}` }} />
        </h4>
      </section>
