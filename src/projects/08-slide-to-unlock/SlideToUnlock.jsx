...
export default function SlideToUnlock() {
    ...
    return (
        <div className='container text-center d-flex flex-column border-20 shadow-md' style={{
            ...
            {showLockSlider ? (<LockSlider width={"250px"} handleInput={handleLockSliderInput} sliderValue={lockSliderValue} />) : (<AiFillUnlock className='unlockIcon' onClick={lockScreen} />)}
